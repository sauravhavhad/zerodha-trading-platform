...
function Hero() {
    return ( 
        <div className='container mt-5 mb-5'>
            <div className='row'>
                <h1 className='fs-4 text-center p-5'>We pioneered the discount broking model in India.<br></br>
Now we are breaking ground with our technology.</h1>
            </div>

             <div className='row mt-5 border-top  text-muted fs-6'>
                <div className='col-6  p-5 ' style={{lineHeight:"1.9", fontSize:"1.2em"}}>
                    <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Zerodha, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p>
                    <p>Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India.</p>
                    <p>Over 1.8+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
                </div>
